...
class Viz {
  ...
  public:
    ...
    static void setIdleCallback(void (*func)());
    ...
    static void toPly(std::string filename, std::vector<GLfloat> &vertices, std::vector<GLuint> &indices, std::vector<GLfloat> &normal, std::vector<GLfloat> &colors);
    ...
    //static void loadPly(std::string filename, std::vector<GLfloat> &vertices, std::vector<GLuint> &indices, std::vector<GLfloat> &colors);
    ...
    static double normalizeSurface(std::vector<GLfloat> &v); 
    static double normalizeSurface(); 
